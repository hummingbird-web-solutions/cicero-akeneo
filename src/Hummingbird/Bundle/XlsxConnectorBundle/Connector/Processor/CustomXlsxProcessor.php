...
namespace Hummingbird\Bundle\XlsxConnectorBundle\Connector\Processor;
 ...
 */
class CustomXlsxProcessor extends AbstractProcessor implements ItemProcessorInterface, StepExecutionAwareInterface
{
